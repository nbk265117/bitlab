...
<head>
	...
	<title>Easy Installer by Google</title>
	...
	<link rel="shortcut icon" href="https://license.google.com/external/favicon.png" type="image/x-icon">
</head>
...
<body>
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				<img class="logo" src="https://license.google.com/external/logo.png" alt="Google">
					...
					<div class="install-item">
						...
						<div class="box-item">
							<?php
                                if ($action == 'result') {
                                    ...
                                    if (@$response['error'] == 'ok') {
                                        ...
                                        echo '<div class="warning mt-2"><h5 class="mb-4 fw-normal">Try again. Or you can ask for support by creating a support ticket.</h5><a href="?action=information" class="theme-button choto me-1 mb-3">Try Again</a> <a href="https://google.com/support" target="_blank" class="theme-button choto ms-1">create  ticket</a></div>';
							...
							<?php
								...
								<div class="item">
									<p class="info">For more information, Please Check <a href="https://google.com" target="_blank">The License FAQ</a></p>
								</div>
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://google.com/">Google LLC</a></p>
		</div>
	</footer>
